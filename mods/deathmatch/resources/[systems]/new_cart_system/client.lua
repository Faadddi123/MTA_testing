--[[
	...
	# Updates
	  ...
	  -Blips support
	  [01.01.2015]
	  -Clean up code and (blips) improvements/optimization
	--------------------------------------
--]]
...
function drawRadar()
	...
	if (not isPlayerMapVisible()) then
		...
		if (alwaysRenderMap or getElementInterior(localPlayer) == 0) then
			...
			dxDrawImage(X - worldW / 2, mH / 5 + (Y - worldH / 2), worldW, worldH, "img/radar_map.png", camZ, (x / (6000 / worldW)), -(y / (6000 / worldH)), tocolor(255, 255, 255, 255))
			dxSetRenderTarget()
		end
